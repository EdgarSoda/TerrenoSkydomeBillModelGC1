...
class Primitivos: public VectorRR, public Imagenes//La clase primitivos hereda de VectorRR e Imagenes
	//VectorRR: Tiene operaciones vectoriales que nos ayudarán a sumar vectores, sacar producto punto, producto cruz.
	//Imagenes nos sirve para abirir imagenes de otros formatos. (JPG, PNG y BITMAP).
{
public:
	int cantVert;
	int cantIndices;
